...
func (x *Laptop) GetWeightTl() float64 {
	if x, ok := x.GetWeight().(*Laptop_WeightTl); ok {
		return x.WeightTl
	}
	return 0
}
...
type Laptop_WeightTl struct {
	WeightTl float64 `protobuf:"fixed64,11,opt,name=weight_tl,json=weightTl,proto3,oneof"`
}

func (*Laptop_WeightKg) isLaptop_Weight() {}

func (*Laptop_WeightTl) isLaptop_Weight() {}
...
var file_laptop_message_proto_rawDesc = []byte{
	...
	0x12, 0x1d, 0x0a, 0x09, 0x77, 0x65, 0x69, 0x67, 0x68, 0x74, 0x5f, 0x74, 0x6c, 0x18, 0x0b, 0x20,
	0x01, 0x28, 0x01, 0x48, 0x00, 0x52, 0x08, 0x77, 0x65, 0x69, 0x67, 0x68, 0x74, 0x54, 0x6c, 0x12,
